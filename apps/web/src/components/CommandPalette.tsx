      ...
      <div className="relative z-10 w-full max-w-md overflow-hidden rounded-xl border border-border bg-surface shadow-2xl">
        <Command label="Command palette" className="[&_[cmdk-input-wrapper]]:border-b [&_[cmdk-input-wrapper]]:border-border">
          <Command.Input
            ...
            className="w-full bg-transparent px-4 py-3.5 text-sm text-slate-200 placeholder:text-slate-500 focus:outline-none"
          />
          <Command.List className="max-h-72 overflow-y-auto p-1.5">
            ...
            <Command.Group heading="Actions" className="[&_[cmdk-group-heading]]:px-2 [&_[cmdk-group-heading]]:py-1.5 [&_[cmdk-group-heading]]:text-xs [&_[cmdk-group-heading]]:text-slate-500">
              <Command.Item
                ...
                className="flex cursor-pointer items-center gap-2.5 rounded-md px-2 py-2 text-sm text-slate-300 aria-selected:bg-white/5"
              >
                <FileUp className="h-4 w-4 text-slate-500" />
                Upload invoice
                <kbd className="ml-auto rounded bg-white/8 px-1.5 py-0.5 text-[10px] text-slate-500">U</kbd>
              </Command.Item>

              {hasInvoices && (
                <Command.Item
                  onSelect={() => run(onClearAll)}
                  className="flex cursor-pointer items-center gap-2.5 rounded-md px-2 py-2 text-sm text-red-400 aria-selected:bg-white/5"
                >
              ...
              >
                ...
                <kbd className="ml-auto rounded bg-white/8 px-1.5 py-0.5 text-[10px] text-slate-500">?</kbd>
              </Command.Item>
            </Command.Group>
